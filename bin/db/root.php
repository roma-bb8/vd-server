...
$commands = file_get_contents(__DIR__ . '/../../tmp/db/root.sql');

echo $connect->multi_query($commands) === true ? 'Root user successfully add to database' . PHP_EOL : 'Error create root: ' . $connect->error . PHP_EOL;
